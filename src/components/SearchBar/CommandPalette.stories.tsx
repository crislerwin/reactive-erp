...
function Welcome() {
  return (
    <div className="w-full rounded-lg border-b border-t border-indigo-500 border-indigo-500 bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-400 p-4">
      <h2 className="text-lg font-semibold leading-tight text-white">
        Welcome 👋
      </h2>
      <p className="mt-1 max-w-xs text-sm font-medium text-white/80">
